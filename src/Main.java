...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("""
                ...
                'castling00' или 'castling000' - для рокировки в соответствующую сторону/ 
                     В общепринятом обороте используются понятия "короткая" и "длинная" рокировки,
                     либо 0-0 и 0-0-0, либо "два нуля" и "три нуля". 
                     Разумно придерживаться соответствующего подхода.
        ...
        while (true) {
            ...
            if (s.equals("exit")) break;
                ...
                if (s.equals("castling00")) {
                    if (board.castling00()) {
                        System.out.println("Рокировка в короткую сторону удалась");
                        board.printBoard();
                    } else {
                        System.out.println("Рокировка не удалась");
                    }
                } else if (s.equals("castling000")) {
                    if (board.castling000()) {
                        System.out.println("Рокировка в длинную сторону удалась");
                        board.printBoard();
                    } else {
                        System.out.println("Рокировка не удалась");
                    }
