    ...
    public boolean moveToPosition(int startLine, int startColumn, int endLine, int endColumn) {
        if (checkPos(startLine) && checkPos(startColumn)) {
            ...
            if (board[startLine][startColumn].canMoveToPosition(this, startLine, startColumn, endLine, endColumn)) {
                ...
                return true;
            } else if (board[startLine][startColumn].hasAttackToPosition(this, startLine, startColumn, endLine, endColumn)) {
                board[endLine][endColumn] = board[startLine][startColumn]; // if piece can move, we moved a piece
                board[startLine][startColumn] = null; // set null to previous cell
                this.nowPlayer = this.nowPlayerColor().equals("White") ? "Black" : "White";
                return true;
        ...
        if (nowPlayer.equals("White")) {
            ...
            if (board[0][0].getSymbol().equals("R") && board[0][4].getSymbol().equals("K") && // check that King and Rook
                ...
                if (board[0][0].getColor().equals("White") && board[0][4].getColor().equals("White") &&
                        ...
                        !new King("White").isUnderAttack(board[0][4], this, 0, 2) && // check that position not in under attack
                        !board[0][4].isUnderAttack(board[0][4], this, 0, 3) &&
                        !board[0][4].isUnderAttack(board[0][4], this, 0, 4)) { // check that position not in under attack
                    board[0][4] = null;
            ...
            if (board[7][0].getSymbol().equals("R") && board[7][4].getSymbol().equals("K") && // check that King and Rook
                ...
                if (board[7][0].getColor().equals("Black") && board[7][4].getColor().equals("Black") &&
                        ...
                        !new King("Black").isUnderAttack(board[7][4], this, 7, 2) &&
                        !board[7][4].isUnderAttack(board[7][4], this, 7, 3) &&
                        !board[7][4].isUnderAttack(board[7][4], this, 7, 4)) { // check that position not in under attack
                    board[7][4] = null;
        ...
        if (nowPlayer.equals("White")) {
            ...
            if (board[0][4].getSymbol().equals("K") && board[0][7].getSymbol().equals("R") && // check that King and Rook
                ...
                if (board[0][4].getColor().equals("White") && board[0][7].getColor().equals("White") &&
                        ...
                        !new King("White").isUnderAttack(board[0][4], this, 0, 6) &&
                        !board[0][4].isUnderAttack(board[0][4], this, 0, 5) && // check that position not in under attack
                        !board[0][4].isUnderAttack(board[0][4], this, 0, 4)) { // check that position not in under attack
                    board[0][4] = null;
            ...
            if (board[7][4].getSymbol().equals("K") && board[7][7].getSymbol().equals("R") && // check that King and Rook
                ...
                if (board[7][4].getColor().equals("Black") && board[7][7].getColor().equals("Black") &&
                        ...
                        !new King("Black").isUnderAttack(board[7][4], this, 7, 6) &&
                        !board[7][4].isUnderAttack(board[7][4], this, 7, 5) && // check that position not in under attack
                        !board[7][4].isUnderAttack(board[7][4], this, 7, 4)) { // check that position not in under attack
                    board[7][4] = null;
